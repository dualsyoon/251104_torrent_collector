...
from .workers import ScraperThread, SingleThumbnailReplaceThread
...
# NOTE: `ScraperThread`, `SingleThumbnailReplaceThread`는 `gui/workers.py`로 이동했습니다.
class MainWindow(QMainWindow):
    ...
    def open_settings(self):
        """설정 다이얼로그 열기"""
        settings = QSettings()
        current_width, current_height, current_hover = load_ui_settings(settings)
